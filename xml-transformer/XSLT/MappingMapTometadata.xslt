		...
		<resource xmlns="http://datacite.org/schema/kernel-4">
			...
			<xsl:for-each select="ns0:resource">
				...
				<xsl:for-each select="ns0:contributors">
					...
					<xsl:if test="not(boolean(translate(normalize-space($var14_nested), ' 0', '')))">
						<contributors>
							<xsl:for-each select="(./ns0:contributor)[not(contains(@contributorType, 'Funder'))]">
						...
						<xsl:for-each select="ns0:description">
							...
							<description>
								...
								<xsl:for-each select="node()">
									<xsl:variable name="var40_sd" select="."/>
								...
								<xsl:for-each select="ns0:geoLocationPlace">
									...
									<geoLocationPlace>
										<xsl:for-each select="(./node())[./self::text()]">
											<xsl:variable name="var44_filter" select="."/>
											<xsl:value-of select="."/>
										</xsl:for-each>
									</geoLocationPlace>
								</xsl:for-each>
				...
				<xsl:for-each select="ns0:contributors">
					<xsl:variable name="var47_filter" select="."/>
					...
					<xsl:if test="boolean(translate(normalize-space($var48_nested), ' 0', ''))">
						<fundingReferences>
